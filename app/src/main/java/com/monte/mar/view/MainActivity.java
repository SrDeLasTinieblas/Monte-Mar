...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    private final List<Trolley> productsList = new ArrayList<>();
        ...
        StringRequest request = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            //Sleep(5000);
                            Type typeList = new TypeToken<List<Trolley>>() {
                            }.getType();

                            List<Trolley> productsListResponse = new Gson().fromJson(response, typeList);
